...
public class TestPerezosoCazador {
	...
	public void fantasmaPerezosoNoVePacManYSeMueve(){
		...
		Fantasma fantasma = crearFantasmaPerezosoNivelUno(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaPerezosoVePacManYSeAcerca(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
		Laberinto laberinto = escenario.getLaberinto();
		Fantasma fantasma = crearFantasmaPerezosoNivelUno(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(2,3)));
	...
	private Fantasma crearFantasmaPerezosoNivelUno(Laberinto laberinto, Posicion posicion) {
