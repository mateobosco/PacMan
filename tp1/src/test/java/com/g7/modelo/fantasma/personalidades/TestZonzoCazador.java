...
public class TestZonzoCazador {
	...
	@Test
	public void fantasmaZonzoNoVePacManYSeMueve(){
		...
		Fantasma fantasma = crearFantasmaZonzoNivelUno(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaZonzoVePacManYSeAcerca(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
		Laberinto laberinto = escenario.getLaberinto();
		Fantasma fantasma = crearFantasmaZonzoNivelUno(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(2,3)));
	...
	@Test
	public void fantasmaZonzoDejaDeVerAlPacManYSeMueve(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	private Fantasma crearFantasmaZonzoNivelUno(Laberinto laberinto, Posicion posicion) {
