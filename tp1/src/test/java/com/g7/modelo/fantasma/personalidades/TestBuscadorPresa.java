...
public class TestBuscadorPresa {
	...
	public void fantasmaBuscadorNoVePacManYSeMueve(){
		...
		Fantasma fantasma = crearFantasmaBuscadorPresa(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaBuscadorVePacManYSeAleja(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
		Laberinto laberinto = escenario.getLaberinto();
		Fantasma fantasma = crearFantasmaBuscadorPresa(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(2,3)));
	...
	@Test
	public void fantasmaBuscadorDejaDeVerAlPacManYSeAlejaDeLaUltimaPosicionPacMan(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaBuscadorSeAlejaHastaNoVerLaUltimaPosicionPacManYSeSigueMoviendo(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	private Fantasma crearFantasmaBuscadorPresa(Laberinto laberinto, Posicion posicion) {
