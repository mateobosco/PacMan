...
public class TestBuscadorTemperamentalPresa {
	...
	@Test
	public void fantasmaBuscadorTemperamentalNoVePacManYSeMueve(){
		...
		Fantasma fantasma = crearFantasmaBuscadorTemperamentalPresa(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaBuscadorTemperamentalVePacManYSeAleja(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
		Laberinto laberinto = escenario.getLaberinto();
		Fantasma fantasma = crearFantasmaBuscadorTemperamentalPresa(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(2,3)));
	...
	@Test
	public void fantasmaBuscadorTemperamentalDejaDeVerAlPacManYSeAlejaDeLaUltimaPosicionPacMan(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaBuscadorTemperamentalSeAlejaHastaNoVerLaUltimaPosicionPacManYSeSigueMoviendo(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	private Fantasma crearFantasmaBuscadorTemperamentalPresa(Laberinto laberinto, Posicion posicion) {
