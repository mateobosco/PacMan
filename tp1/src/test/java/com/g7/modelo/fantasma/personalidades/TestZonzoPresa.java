...
public class TestZonzoPresa {
	...
	public void fantasmaZonzoNoVePacManYSeMueve(){
		...
		Fantasma fantasma = crearFantasmaZonzoPresa(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
	...
	@Test
	public void fantasmaZonzoVePacManYSeAleja(){
		PacMan pacman = new PacMan(new ConfiguracionTicks());
		Escenario escenario = new Escenario(crearLaberintoCompletoDeNPosiciones(15),pacman);
		pacman.setLaberinto(escenario.getLaberinto());
		pacman.setPosicion(new Posicion(numeroAleatorio(1),numeroAleatorio(1)));
		Laberinto laberinto = escenario.getLaberinto();
		Fantasma fantasma = crearFantasmaZonzoPresa(laberinto, new Posicion(numeroAleatorio(1),numeroAleatorio(2,3)));
	...
	private Fantasma crearFantasmaZonzoPresa(Laberinto laberinto, Posicion posicion) {
